...
NAxcD_Yeo7_51ROIs_as = zeros(51, 51, 47);
NAxcR_Yeo7_51ROIs_as = zeros(51, 51, 47);
...
for nS = 1:length(subG)
        ...
        Yeo7Idx = zeros(length(chanLabels), 1);
        % Iterate through all channels
        for nChan = 1:length(chanLabels)
            a = strcmp(chanLabels{nChan}, contAnat.label);
        ...
        NAxcD_Yeo7_51ROIs = cell(51, 51);
        NAxcR_Yeo7_51ROIs = cell(51, 51);
        % Collect all valid channel pairs between regions
        for nChan1 = 1:size(NAxcD, 1)
                for nChan2 = 1:size(NAxcD, 1)
                    yeo7Idx1 = Yeo7Idx(nChan1); yeo7Idx2 = Yeo7Idx(nChan2);
                    ...
                    if yeo7Idx1>0 && yeo7Idx2>0
                        ...
                        NAxcD_Yeo7_51ROIs{yeo7Idx1, yeo7Idx2} = ...
                            [NAxcD_Yeo7_51ROIs{yeo7Idx1, yeo7Idx2}, NAxcD(nChan1, nChan2)];
                        NAxcR_Yeo7_51ROIs{yeo7Idx1, yeo7Idx2} = ...
                            [NAxcR_Yeo7_51ROIs{yeo7Idx1, yeo7Idx2}, NAxcR(nChan1, nChan2)];
                    end
                end
        end
        ...
        for n1 = 1:51
            for n2 = 1:51
                NAxcD_Yeo7_51ROIs_as(n1, n2, nS) = mean(NAxcD_Yeo7_51ROIs{n1, n2}, 'omitnan');
                NAxcR_Yeo7_51ROIs_as(n1, n2, nS) = mean(NAxcR_Yeo7_51ROIs{n1, n2}, 'omitnan');
            end
        end
end
NAxcD_Yeo7_51ROIs_as_mean = mean(NAxcD_Yeo7_51ROIs_as, 3, 'omitnan');
NAxcR_Yeo7_51ROIs_as_mean = mean(NAxcR_Yeo7_51ROIs_as, 3, 'omitnan');
saveFolder = 'step7_IEDtw_Yeo7';
saveName = 'NAxc_delays_strength_Yeo7_51ROIs.mat';
save(fullfile(saveFolder, saveName),  'NAxcD_Yeo7_51ROIs_as_mean', 'NAxcR_Yeo7_51ROIs_as_mean');