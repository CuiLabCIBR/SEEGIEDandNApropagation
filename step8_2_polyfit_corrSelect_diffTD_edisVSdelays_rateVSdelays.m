...
% polynomial fitting to remove distance confounding, and bootstrap 
% validation for different IED detection thresholds.
...
subG = {'sub-0001', 'sub-0002', 'sub-0003', 'sub-0004', 'sub-0005', ...
            ...
            'sub-0113', 'sub-0115'};
thd = 5:0.2:9;% IED detection threshould
...
for nTD = 1:length(thd)
    ...
    load(fullfile('step8_IEDtravelingWave_corrSelect', ['IEDtw_meth-corrSelect_TD-', thd_str{nTD}, '.mat']));
    ...
    mkdir(saveFolder);
    saveName = ['IEDtw_meth-corrSelect_TD-', thd_str{nTD}, '_polyfit.mat'];
