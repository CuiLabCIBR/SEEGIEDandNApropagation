...
for nS = 1:length(subG)
        ...
        [polyModel, ~, ~] = f_polyfit(ED, IEDxcD, 6);
        ...
        [R_fibNxcD_rED(nS), P_fibNxcD_rED(nS)] = corr(fibNres, IEDxcDres, "type", "Spearman");
end
% Save results
saveFolder = 'step5_IEDxcorr_polyfit';
saveName = 'IED6d0_XC100ms_polyfit_delay_fibN';
save(fullfile(saveFolder, saveName), 'R_fibNxcD', 'P_fibNxcD', ...
    'R_fibNxcD_rED', 'P_fibNxcD_rED');