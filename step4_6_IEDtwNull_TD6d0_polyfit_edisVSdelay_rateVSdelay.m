...
parfor nNull = 1:1000
    ...
    [op1, op2] = subparfor(delayNull, rateNull, distanceAll);
    % subject level polyfit
    R_twDR(:, nNull) = op1.R_twDR; 
    P_twDR(:, nNull) = op1.P_twDR;
    R_twDR_rED(:, :, nNull) = op1.R_twDR_rED; 
    P_twDR_rED(:, :, nNull) = op1.P_twDR_rED;
    adjR2_twDED(:, :, nNull) = op1.adjR2_twDED;
    % group level polyfit
    R_twDR_as(:, nNull) = op2.R_twDR_as; 
    P_twDR_as(:, nNull) = op2.P_twDR_as;
    R_twDR_rED_as(:, :, nNull) = op2.R_twDR_rED_as; 
    P_twDR_rED_as(:, :, nNull) = op2.P_twDR_rED_as;
    adjR2_twDED_as(:, :, nNull) = op2.adjR2_twDED_as;
end
...
function [op1, op2] = subparfor(delayNull, rateNull, distanceAll)
    EDas = []; 
    IEDtwDas = []; 
    IEDtwRas = [];
    for nS = 1:47
    ...
    op1.R_twDR = R_twDR; 
    op1.P_twDR = P_twDR;
    op1.R_twDR_rED = R_twDR_rED; 
    op1.P_twDR_rED = P_twDR_rED;
    op1.adjR2_twDED = adjR2_twDED;
    for nIf = 1:25
