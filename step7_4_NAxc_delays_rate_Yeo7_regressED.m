...
for nS = 1:length(subG)
        ...
        NAxcD(Mask>0) = polyModel.residual + polyModel.p(end);
        y = NAxcR(Mask>0);
        polyModel = f_polyfit(x, y, 1);
        NAxcR(Mask>0) = polyModel.residual + polyModel.p(end);
        %% Map channel to Yeo7 network
        Yeo7 = {};
        ...
        NAxcD_Yeo7 = cell(11, 11); 
        ED_Yeo7 = cell(11, 11);
        NAxcR_Yeo7 = cell(11, 11);
...
mkdir(saveFolder);
saveName = 'NAxc_delays_rate_Yeo7_rED.mat';
