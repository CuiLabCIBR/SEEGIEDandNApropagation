...
subG = {'sub-0001', 'sub-0002', 'sub-0003', 'sub-0004', 'sub-0005', ...
    ...
    'sub-0113', 'sub-0115'};
% Load IED traveling wave delays and rate data
load(fullfile('step8_IEDtravelingWave_corrSelect', 'IEDtw_meth-corrSelect_TD-6d0.mat'));
...
for nS = 1:length(subG)
    ...
    load(fullfile('step2_channelDistance', [subG{nS},'_EuclideabDistanceMatrix.mat']));
...
parfor nIf = 1:1000
    ...
    % Bootstrap polynomial fit quality between Euclidean distance and delays
    adjR2_twDED_as(nIf, :) = iforest_polyfit(EDas, IEDtwDas);
end
saveFolder = 'step8_IEDtravelingWave_corrSelect';
mkdir(saveFolder);
saveName = 'IEDtw_meth-corrSelect_TD-6d0_polyfit-edisVSdelay_rateVSdelay.mat';
