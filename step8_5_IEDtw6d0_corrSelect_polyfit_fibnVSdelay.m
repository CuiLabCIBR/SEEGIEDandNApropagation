...
subG = {'sub-0001', 'sub-0002', 'sub-0003', 'sub-0004', 'sub-0005', ...
                ...
                'sub-0113', 'sub-0115'};
% Load fiber tracking data
load(fullfile('step2_fiberTrack', 'FiberMatrix_ncount_length_qa_allsubject.mat'), 'fiberCount');
% Load IED traveling wave delays and rate
load(fullfile('step8_IEDtravelingWave_corrSelect', 'IEDtw_meth-corrSelect_TD-6d2.mat'));
% Loop through each subject for individual analysis
...
mkdir(saveFolder);
saveName = 'IEDtw_meth-corrSelect_TD-6d0_polyfit1000-fibnVSdelay.mat';
save(fullfile(saveFolder, saveName), ...
    "IEDtwDas", "fibNas",  "EDas", ...
