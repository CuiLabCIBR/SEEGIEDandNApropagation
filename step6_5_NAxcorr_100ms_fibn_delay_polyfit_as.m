...
[R_fibNxcD_as, P_fibNxcD_as] = corr(fibNas, NAxcDas, "type", "Spearman");
% Compute distance-residualized correlations
% Remove distance effect from delays using polynomial fit
[polyModel, ~, ~] = f_polyfit(EDas, NAxcDas, 6);
NAxcDres = polyModel.residual+polyModel.p(end);
...
[R_fibNxcD_rED_as, P_fibNxcD_rED_as] = corr(fibNres, NAxcDres, "type", "Spearman");
% Save results
saveFolder = 'step6_NAxcorr_polyfit';
saveName = 'NAnon6d0IED_XC100ms_polyfit_delay_fibN_as.mat';
save(fullfile(saveFolder, saveName),  ...
    'fibNas', 'NAxcDas', 'fibNres', 'NAxcDres', ...
